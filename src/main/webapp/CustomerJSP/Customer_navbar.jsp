...
<head>
    ...
    background-color: #022c2e; /* Replace with your desired color */
        ...
        .navbar-nav {
            ...
            align-items: center;
            flex-direction: row;
            width: 50%; /* Stretch to full width */
        }
...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <div class="container-fluid">
            <a class="navbar-brand" href="/RevShop_P0/CustomerMainServlet">Products</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/RevShop_P0/header.jsp">Home</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="/RevShop_P0/CustomerFavoriteActionsServlet">
                            <i class="fas fa-heart"></i> Wishlist
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="/RevShop_P0/CustomerCartServlet">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/RevShop_P0/CustomerJSP/CustomerOrderHistory.jsp">My Orders</a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="profileDropdown">
                            <li><a class="dropdown-item" href="CustomerProfileUpdate.jsp">Update Profile</a></li>
                             <li><a class="dropdown-item" href="/RevShop_P0/CustomerAddToWalletServlet">Wallet</a></li>
